  ...
  return (
    <div className="min-h-screen auth-backdrop flex flex-col items-center justify-center p-6">
      ...
      <div className="grid sm:grid-cols-3 gap-4 w-full max-w-2xl">
        ...
        >
          <p className="text-brand-blue font-semibold text-lg">Admin Portal</p>
        ...
        <Link
          ...
          className="rounded-2xl bg-white/95 p-6 shadow-xl hover:shadow-2xl transition text-center border border-white/40"
        >
          <p className="text-brand-teal font-semibold text-lg">Parent Portal</p>
          <p className="text-slate-600 text-sm mt-1">Approve student outpass</p>
        </Link>
      </div>
    </div>
  )
