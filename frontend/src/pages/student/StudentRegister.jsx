          ...
          {!otpSent ? (
            <form onSubmit={sendOtp} className="space-y-4">
              ...
              <div>
                ...
                <input
                  className="w-full rounded-lg border border-slate-200 px-3 py-2.5 focus:ring-2 focus:ring-brand-blue outline-none"
                  value={phone}
            ...
            <form onSubmit={register} className="space-y-3">
              ...
              <div>
                ...
                <input
                  className="w-full rounded-lg border border-slate-200 px-3 py-2.5 outline-none focus:ring-2 focus:ring-brand-blue"
                  value={otp}
