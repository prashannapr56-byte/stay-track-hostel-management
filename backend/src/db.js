...
// Safely add admin_proof if it doesn't exist yet
try {
  rawDb.exec('ALTER TABLE complaints ADD COLUMN admin_proof TEXT;');
} catch (e) {
  // column likely exists
}

// Safely add gender if it doesn't exist yet
try {
  rawDb.exec('ALTER TABLE students ADD COLUMN gender TEXT;');
} catch (e) {
  // column likely exists
}
